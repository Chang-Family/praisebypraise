...
import ComeLordJesusAudio from "./come_lord_jesus-chinese.mp3";

export const meta = {
  title: "Come Lord Jesus",
  audio: ComeLordJesusAudio,
  lyrics_cn: `Come Lord Jesus
  主願祢快來
  詞曲: 張呂佳蓉
  <br/>
  主說的話
...
<audio controls src={ComeLordJesusAudio}></audio>
...
2013 年，三月份，有一次彈琴時, 不禁好想告訴主多麼盼望祂快來, 向主唱了這首歌，那時只有中文一部份的歌詞而以，2014 年 3 月經歷了聖靈, 2015 年, 4 月開始，頌讚主的歌曲就一直湧流出，奇妙的是，聖靈引導我再去完成這首主願祢快來, 第一次自己寫了, 向著主，為著主唱的歌。
